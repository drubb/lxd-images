...
# Install additional php extensions required by Laravel or some cli tools
apk add php7-intl php7-openssl php7-pdo_mysql php7-pdo_sqlite php7-opcache \
        ...
        php7-mbstring php7-session php7-tokenizer php7-simplexml php7-xmlwriter
...
# Add Composer, Laravel and Lumen installers
