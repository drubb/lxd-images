...
apk add php7-intl php7-openssl php7-mysqli php7-pdo_mysql php7-pdo_sqlite php7-opcache \
        php7-gd php7-json php7-xml php7-curl php7-phar php7-xdebug php7-zip php7-ctype php7-ftp \
        php7-mcrypt php7-bcmath php7-zlib php7-dom php7-pcntl php7-iconv php7-posix php7-apcu \
